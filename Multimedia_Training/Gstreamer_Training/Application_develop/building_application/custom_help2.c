...
int main(int argc, char *argv[]) {
  ...
  // Set custom names for the default help options
  g_option_context_set_summary (ctx, "my-help");
  g_option_context_set_help_enabled (ctx, TRUE); // Enable custom help options
