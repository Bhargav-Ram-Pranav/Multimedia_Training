...
int main(int argc, char *argv[]) {
    ...
    video_src_pad = gst_element_request_pad_simple(demuxer, "video_0");
    audio_src_pad = gst_element_request_pad_simple(demuxer, "audio_0");
    ...
    // Get the capabilities (caps) of the video and audio source pads
    video_caps = gst_pad_query_caps(video_src_pad, NULL);
    audio_caps = gst_pad_query_caps(audio_src_pad, NULL);
