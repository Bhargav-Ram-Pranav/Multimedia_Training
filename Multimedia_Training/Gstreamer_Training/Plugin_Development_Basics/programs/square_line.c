...
static GstPadProbeReturn frame_probe(GstPad *pad, GstPadProbeInfo *info, gpointer user_data) {
    ...
    if (gst_video_info_from_caps(&video_info, gst_pad_get_current_caps(pad)) &&
        ...
        // Define the center coordinates (x, y) and size of the square
        gint square_center_x = 100; // X-coordinate of the center
        gint square_center_y = 100; // Y-coordinate of the center
        gint square_size = 100; // Size of the square (side length)
