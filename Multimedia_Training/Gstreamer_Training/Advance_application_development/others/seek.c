...
int main(int argc, char *argv[]) {
    ...
    /* Wait for a while to allow the pipeline to start playing */
    //g_usleep(1 * GST_SECOND);  // Wait for 1 second (adjust if needed)
    ...
    /* Run the main loop to periodically print position and duration */
