...
def run_pipeline(width, height):
    # Define the gst-launch-1.0 command with modified videotestsrc properties
    pipeline_command = f'gst-launch-1.0 videotestsrc pattern=smpte ! video/x-raw,width={width},height={height},format=I420 ! autovideosink'
